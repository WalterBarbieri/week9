...
class Autonomo1 extends index_1.PIva {
    constructor(_ral, _codredd = 0.4) {
        super(_codredd, _ral);
    }
}
class Autonomo2 extends index_1.PIva {
    constructor(_ral, _codredd = 0.54) {
        super(_codredd, _ral);
    }
}
class Autonomo3 extends index_1.PIva {
    constructor(_ral, _codredd = 0.62) {
        super(_codredd, _ral);
    }
}
class Autonomo4 extends index_1.PIva {
    constructor(_ral, _codredd = 0.67) {
        super(_codredd, _ral);
    }
}
class Autonomo5 extends index_1.PIva {
    constructor(_ral, _codredd = 0.78) {
        super(_codredd, _ral);
    }
}
class Autonomo6 extends index_1.PIva {
    constructor(_ral, _codredd = 0.86) {
        super(_codredd, _ral);
    }
}
